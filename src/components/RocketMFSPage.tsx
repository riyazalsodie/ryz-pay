...
const RocketMFSPage: React.FC<RocketMFSPageProps> = ({ onBack, onCancel, onVerify }) => {
  ...
  const recipientNumber = '017629050134'
  const amount = '2200'
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm">
          <div className="bg-white rounded-lg p-8 shadow-2xl">
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 border-4 border-[#89288f] border-t-transparent rounded-full animate-spin"></div>
              <p className="mt-4 text-slate-600 font-bangla">যাচাই করা হচ্ছে...</p>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="w-full">
          <div className="flex flex-col sm:flex-row flex-wrap sm:mt-5 sm:justify-between sm:items-center">
            <div className="w-full h-20 mb-4 sm:mt-0 flex justify-center items-center">
              <img src="/assets/rocket.png" alt="Rocket" className="h-[80%] object-contain" />
            </div>
          ...
          <form onSubmit={handleSubmit} className="mt-3">
            <div className="bg-[#89288f] p-5 rounded-lg overflow-auto">
              ...
              <div className="mt-5">
                <ul className="text-slate-200 space-y-3">
                  <li className="flex text-sm">
                    ...
                    <p className="font-bangla">প্রথমে আপনার ফোনের Rocket অ্যাপে প্রবেশ করুন।</p>
                  </li>
                  <hr className="border-[#6c1e70] my-3" />
                  <li className="flex text-sm">
                    <div><span className="inline-block w-1.5 h-1.5 mr-2 bg-white rounded-full mb-0.5"></span></div>
                  ...
                  <li className="flex text-sm">
                    <div><span className="inline-block w-1.5 h-1.5 mr-2 bg-white rounded-full mb-0.5"></span></div>
                    <p className="font-bangla">নিশ্চিত করতে এখন আপনার Rocket মোবাইল মেনু পিন লিখুন।</p>
                  </li>
                  <hr className="border-[#6c1e70] my-3" />
                  <li className="flex text-sm">
                    <div><span className="inline-block w-1.5 h-1.5 mr-2 bg-white rounded-full mb-0.5"></span></div>
                    <p className="font-bangla">সবকিছু ঠিক থাকলে, আপনি Rocket থেকে একটি নিশ্চিতকরণ বার্তা পাবেন।</p>
                  </li>
                  <hr className="border-[#6c1e70] my-3" />
                  <li className="flex text-sm">
                    <div><span className="inline-block w-1.5 h-1.5 mr-2 bg-white rounded-full mb-0.5"></span></div>
