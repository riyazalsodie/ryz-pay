        ...
        <div className="animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="space-y-3">
                <input
                    ...
                    className="w-full p-3 border border-[#0057d0]/20 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0057d0]/30 font-mono text-center uppercase tracking-widest placeholder:font-bangla placeholder:tracking-normal"
                />
                <button
                    disabled={!trxId}
                    className="w-full bg-[#0057d0] text-white py-3 rounded-md font-bold font-bangla hover:bg-[#004cb7] transition-colors disabled:opacity-50 disabled:cursor-not-allowed uppercase tracking-wide"
                >
                    VERIFY
                </button>
            </div>
