...
const CellfinMFSPage: React.FC<CellfinMFSPageProps> = ({ onBack, onCancel, onVerify, gateway, transaction }) => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm dark:bg-black/50">
          <div className="bg-white rounded-lg p-8 shadow-2xl dark:bg-[#111] dark:border dark:border-white/10">
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 border-4 border-[#00803d] border-t-transparent rounded-full animate-spin"></div>
        ...
        <div className="w-full h-12 shadow-md shadow-[#0057d0]/5 rounded-lg overflow-hidden flex justify-between items-center p-5 bg-white sm:bg-[#fbfcff] sm:shadow-none sm:ring-1 sm:ring-[#0057d0]/10 dark:bg-black dark:border-b dark:border-white/10 dark:ring-0 dark:shadow-none">
          ...
          <div className="flex items-center gap-5">
            <button onClick={toggleLanguage} className="hover:opacity-70 transition-opacity" aria-label="Change language">
              <svg width="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M5.39719 7.97288L4.88063 9.5H3.5625L5.77362 3.5625H7.29837L9.5 9.5H8.11419L7.59762 7.97288H5.39719ZM7.33756 7.09888L6.53125 4.69775H6.47306L5.66675 7.09888H7.33756Z" className="fill-[#94A9C7] dark:fill-gray-400"></path>
        ...
        <div className="w-full">
          <div className="flex flex-col sm:flex-row flex-wrap sm:mt-5 sm:justify-between sm:items-center">
            <div className="w-full h-20 mb-4 sm:mt-0 flex justify-center items-center">
              <img src="/assets/cellfin.png" alt="Cellfin" className="h-[80%] object-contain" />
            </div>
          ...
          <form onSubmit={handleSubmit} className="mt-3">
            <div className="bg-[#00803d] p-5 rounded-lg overflow-auto">
              ...
              <div className="mt-5">
                {instructions ? (
                  ...
                  <li className="flex text-sm">
                    <div><span className="inline-block w-1.5 h-1.5 mr-2 bg-white rounded-full mb-0.5"></span></div>
                    <p className="font-bangla">নিশ্চিত করতে এখন আপনার CELLFIN মোবাইল মেনু পিন লিখুন।</p>
                  </li>
                  <hr className="border-[#016e35] my-3" />
                  <li className="flex text-sm">
                    <div><span className="inline-block w-1.5 h-1.5 mr-2 bg-white rounded-full mb-0.5"></span></div>
