        ...
        <div className="animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="space-y-3">
                <input
                    ...
                    className="w-full p-3 border border-[#0057d0]/20 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0054a6]/30 text-left uppercase tracking-widest placeholder:font-bangla placeholder:tracking-normal"
                />
                <button
                    disabled={!trxId}
