    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${filter === "paid" ? "bg-white text-black" : "bg-white/5 text-gray-400 hover:text-white"}`}
        >
          Paid
        </button>
        <button
          onClick={() => setFilter("unpaid")}
          className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${filter === "unpaid" ? "bg-white text-black" : "bg-white/5 text-gray-400 hover:text-white"}`}
        >
          Unpaid
        </button>
        <button
          onClick={() => setFilter("partial")}
          className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${filter === "partial" ? "bg-white text-black" : "bg-white/5 text-gray-400 hover:text-white"}`}
        >
          Partial
        </button>
        <button
          onClick={() => setFilter("refunded")}
          className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${filter === "refunded" ? "bg-white text-black" : "bg-white/5 text-gray-400 hover:text-white"}`}
        >
          Refunded
        </button>
        <button
          onClick={() => setFilter("canceled")}
          className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${filter === "canceled" ? "bg-white text-black" : "bg-white/5 text-gray-400 hover:text-white"}`}
        >
          Canceled
        </button>
      </div>
                ...
                filteredInvoices.map((invoice) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-3 py-1 rounded-full text-xs font-medium border ${getStatusBadge(invoice.status)}`}
                      >
                        {invoice.status}
                      </span>
                    </td>
