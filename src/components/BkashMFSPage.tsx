...
const BkashMFSPage: React.FC<BkashMFSPageProps> = ({ onBack, onCancel, onVerify, gateway, transaction }) => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm dark:bg-black/50">
          <div className="bg-white rounded-lg p-8 shadow-2xl dark:bg-[#111] dark:border dark:border-white/10">
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 border-4 border-[#e2136e] border-t-transparent rounded-full animate-spin"></div>
      ...
      <div className="up-container max-w-md overflow-hidden mx-auto p-8 sm:relative sm:bg-white sm:rounded-lg sm:shadow-lg sm:shadow-[#0057d0]/10 sm:min-w-[650px] sm:flex sm:flex-wrap dark:bg-black dark:border dark:border-white/10 dark:shadow-none">
        ...
        <div className="w-full">
          ...
          <form onSubmit={handleSubmit} className="mt-3">
            {/* Instructions Box */}
            <div className="bg-[#e2136e] p-5 rounded-lg overflow-auto">
            ...
            <div className="mt-5">
              <motion.button
                ...
                className="bg-[#e2136e] hover:bg-[#c91062] disabled:opacity-50 disabled:cursor-not-allowed block rounded-[10px] px-4 py-3.5 text-center font-semibold text-white transition-colors w-full shadow-lg shadow-[#e2136e]/20"
              >
