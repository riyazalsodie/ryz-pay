        ...
        <div className="animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="space-y-4 mb-6">
                <div className="bg-white rounded-md border border-[#0057d0]/20 p-3 relative overflow-hidden group dark:bg-black dark:border-white/20">
                    ...
                    <div className="flex justify-between items-center">
                        <span className="text-lg font-bold text-slate-700 tracking-wider dark:text-white">017629050134</span>
                        <CopyButton textToCopy="017629050134" className="bg-[#89288f] hover:bg-[#6c1e70] text-white" />
                    </div>
                </div>
            ...
            <div className="space-y-3">
                <input
                    ...
                    className="w-full p-3 border border-[#0057d0]/20 rounded-md focus:outline-none focus:ring-2 focus:ring-[#89288f]/30 text-left uppercase tracking-widest placeholder:font-bangla placeholder:tracking-normal dark:bg-[#111] dark:text-white dark:border-white/20 dark:placeholder-gray-500"
                />
                <button
                    disabled={!trxId}
