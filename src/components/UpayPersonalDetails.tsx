        ...
        <div className="animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="space-y-4 mb-6">
                <div className="bg-white rounded-md border border-[#0057d0]/20 p-3 relative overflow-hidden group dark:bg-black dark:border-white/20">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <CopyButton textToCopy="01762905013" className="bg-[#0054a6] hover:bg-[#00468a] text-white" />
                    </div>
                </div>
            ...
            <div className="space-y-3">
                <input
                    ...
                    className="w-full p-3 border border-[#0057d0]/20 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0054a6]/30 text-left uppercase tracking-widest placeholder:font-bangla placeholder:tracking-normal dark:bg-[#111] dark:text-white dark:border-white/20 dark:placeholder-gray-500"
                />
                <button
                    disabled={!trxId}
