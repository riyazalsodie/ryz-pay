    ...
    <div className="w-full h-12 shadow-md shadow-[#0057d0]/5 rounded-lg overflow-hidden flex justify-between items-center p-5 bg-white sm:bg-[#fbfcff]  sm:shadow-none sm:ring-1 sm:ring-[#0057d0]/10 dark:bg-black dark:border-b dark:border-white/10 dark:ring-0 dark:shadow-none">
      ...
      <div className="flex items-center gap-5">
        <button onClick={toggleLanguage} className="flex items-center justify-center">
          <svg width="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 cursor-pointer hover:opacity-70 transition-opacity">
        ...
        <form action="#" method="post">
          <button type="submit" className="flex items-center justify-center">
            <X className="w-5 h-5 text-[#94A9C7] hover:text-[#6D7F9A] transition-colors" />
          </button>
        </form>
      </div>
    </div>
